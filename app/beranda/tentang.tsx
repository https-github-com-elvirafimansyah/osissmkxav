      ...
      <Container>
          <div className="flex justify-between flex-col md:flex-row items-center gap-y-10 md:gap-y-0">
            <div className="flex flex-col space-y-3 w-full md:w-4/6">
                <p className="bg-white dark:bg-card text-primary w-fit uppercase py-[13px] px-[20px] text-sm font-semibold rounded-full">tentang kami</p>
                <h1 className="text-4xl md:text-4xl lg:text-[40px] font-black">Siapa Kami?</h1>
