              ...
              <div className="space-y-3" >
                <div className="space-y-2">
                  ...
                  <div className="space-y-1">
                    <h2 className="text-lg lg:text-xl font-extrabold hover:underline hover:decoration-primary underline-offset-4 line-clamp-2 text-ellipsis capitalize"><Link href=''>{_.title}</Link></h2>
