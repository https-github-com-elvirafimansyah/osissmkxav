      ...
      <section className="py-10 md:py-16 lg:py-20 overflow-hidden">
        <div className="flex flex-col md:flex-row lg:items-center justify-between md:space-x-2 space-y-4 md:space-y-0">
          <div className="md:w-3/4 lg:w-1/2 space-y-3">
            ...
            <p className="text-gray-700 text-base md:text-sm lg:text-base">Selamat datang di website resmi OSIS/OSISKA SMK Xaverius Palembang. Website ini berisi informasi tentang OSISKA SMK  Xaverius Palembang masa bakti 2024.</p>
